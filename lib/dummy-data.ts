...
export const dummyStudents: Student[] = [
  {
    ...
    matricule: 'UB20S1234',
    instEmail: 'acha.brandon@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB21S0045',
    instEmail: 'njeck.carine@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB22S1498',
    instEmail: 'mbah.vanessa@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB21S0832',
    instEmail: 'fotso.cedric@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB23S0112',
    instEmail: 'niba.dillion@ubuea.cm',
    personalEmail: 'nibadillion@gmail.com',
    phone: '+237 673 45 67 89',
    faculty: 'Advanced School of Translators and Interpreters',
    dept: 'Translation',
    level: 100,
    tuitionStatus: 'Paid',
    medicalStatus: 'Cleared',
  },
  {
    ...
    matricule: 'UB22S0490',
    instEmail: 'agbortoko.christabel@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB20S1567',
    instEmail: 'atangana.marie@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB21S1902',
    instEmail: 'tanyi.samuel@ubuea.cm',
  ...
  },
  {
    ...
    matricule: 'UB23S0743',
    instEmail: 'epie.ndille@ubuea.cm',
...
export const dummyResources: Resource[] = [
  {
    ...
    type: 'notes',
    url: 'https://www.ubuea.cm/resources/eeg311-embedded-systems.pdf',
    faculty: 'Faculty of Engineering and Technology',
    dept: 'Electrical Engineering',
    level: 300,
  },
  {
    ...
    type: 'pastpaper',
    url: 'https://www.ubuea.cm/resources/ceg415-pastpaper-2023.pdf',
    faculty: 'Faculty of Engineering and Technology',
    dept: 'Computer Engineering',
    level: 400,
  },
  {
    ...
    type: 'youtube',
    url: 'https://www.youtube.com/watch?v=kYI_tVqQ_pE',
    faculty: 'Faculty of Science',
    dept: 'Biochemistry',
    level: 200,
  },
  {
    ...
    type: 'pastpaper',
    url: 'https://www.ubuea.cm/resources/csc401-distributed-pastpaper.pdf',
    faculty: 'Faculty of Science',
    dept: 'Computer Science',
    level: 400,
  },
  {
    ...
    type: 'notes',
    url: 'https://www.ubuea.cm/resources/eco201-notes.pdf',
    faculty: 'Faculty of Social and Management Sciences',
    dept: 'Economics',
    level: 200,
  },
  {
    ...
    type: 'youtube',
    url: 'https://www.youtube.com/watch?v=FqE2YyO63l8',
    faculty: 'Faculty of Social and Management Sciences',
    dept: 'Journalism and Mass Communication',
    level: 200,
  },
  {
    ...
    type: 'notes',
    url: 'https://www.ubuea.cm/resources/nur405-critical-care.pdf',
    faculty: 'Faculty of Health Sciences',
    dept: 'Nursing',
    level: 400,
  },
  ...
  },
  {
    ...
    type: 'notes',
    url: 'https://www.ubuea.cm/resources/tra101-theory-pack.pdf',
    faculty: 'Advanced School of Translators and Interpreters',
    dept: 'Translation',
    level: 100,
  },
  {
    ...
    type: 'pastpaper',
    url: 'https://www.ubuea.cm/resources/med302-pediatric-cases.pdf',
    faculty: 'Faculty of Health Sciences',
    dept: 'Medicine',
    level: 300,
  },
...
export const dummyTickets: Ticket[] = [
  {
    id: 't-101',
    studentMatricule: 'UB20S1234',
    subject: 'Tuition Fee Payment Update Delay',
    description: 'I paid my balance of 25,000 CFA Francs through MTN Mobile Money yesterday, but my student dashboard still marks my status as Overdue.',
    status: 'open',
    date: '2026-06-23',
    messages: [
      {
        sender: 'student',
        text: 'I paid my balance of 25,000 CFA Francs through MTN Mobile Money yesterday, but my student dashboard still marks my status as Overdue.',
  ...
  {
    id: 't-102',
    studentMatricule: 'UB21S0045',
    subject: 'Medical Clearance Pending Status',
    description: 'I completed my medical screening at the University of Buea Health Center last week but it is still showing pending on the dashboard. I need this to register for exams.',
    status: 'open',
    date: '2026-06-22',
    messages: [
      {
        sender: 'student',
        text: 'I completed my medical screening at the University of Buea Health Center last week but it is still showing pending on the dashboard. I need this to register for exams.',
  ...
  },
  {
    ...
    messages: [
      ...
      {
        sender: 'admin',
        text: 'Hello Boris. Your institutional account has been reset. Please use the temporary password UB@2026 to log in and change your password immediately.',
  ...
  {
    id: 't-105',
    studentMatricule: 'UB22S1498',
    subject: 'Course Registration Portal Issue',
    description: 'I am unable to select JMC204 on my online course registration list. It says pre-requisite JMC102 is missing, but I passed it last semester.',
    status: 'open',
    date: '2026-06-24',
    messages: [
      {
        sender: 'student',
        text: 'I am unable to select JMC204 on my online course registration list. It says pre-requisite JMC102 is missing, but I passed it last semester.',
...
export const dummyCampaigns: Campaign[] = [
  ...
  {
    id: 'c-04',
    title: 'FET Practical Internship Reports Submission',
    audience: 'Level 300',
    message: 'All engineering students are requested to upload their preliminary industrial internship reports by June 28th.',
    sentDate: '2026-06-22',
    status: 'Sent',
  },
  {
    id: 'c-05',
    title: 'Biochemistry Seminar Invitation',
    audience: 'All Students',
    message: 'We invite you to the annual Life Sciences seminar this Friday at Amphi 750 starting from 2:00 PM.',
    sentDate: '2026-06-24',
    status: 'Draft',
  },
];
...
export const dummyActivityFeed: ActivityFeed[] = [
  ...
  {
    id: 'a8',
    action: 'drafted a biochemistry seminar newsletter',
    user: 'Dean of Science',
    time: '3 hours ago',
  },
];
